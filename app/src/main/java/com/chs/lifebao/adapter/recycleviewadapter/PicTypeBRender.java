 ...
 */
public class PicTypeBRender implements ABAdapterTypeRender<ABRecyclerViewTypeExtraHolder> {
    private Context context;
    private PicItemTypeAdapter adapter;
    private ABRecyclerViewTypeExtraHolder holder;

    public PicTypeBRender(Context context, PicItemTypeAdapter adapter) {
